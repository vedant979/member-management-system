...
namespace Project5.Services.Implementation
{
    public class UserService : IUserService
    {
        ...
        public UserService(IUserRepository userRepository, PasswordHasher<string> passwordHasher, JwtTokenGenerator tokenGenerator, IHttpContextAccessor httpContextAccessor)
        {
